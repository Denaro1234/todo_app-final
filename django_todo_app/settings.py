...
DATABASES = {
    'default': dj_database_url.config(
        default='postgresql://postgres:qiYxYLdtqIYPhnDEDBIdvjhwasBhzOab@postgres.railway.internal:5432/railway',
        conn_max_age=600,
        ssl_require=True
    )
}
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'denaro2012@gmail.com'
EMAIL_HOST_PASSWORD = 'ynfd ctxa yzam pcap'  # Use an app-specific password for security
